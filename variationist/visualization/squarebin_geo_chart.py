...
class SquareBinGeoChart(AltairChart):
    """A class for building a SquareBinGeoChart object."""
    ...
    def __init__(
        ...
        """
        Initialization function for a building a SquareBinGeoChart object.
        ...
        bin_width = chart_base_size / num_lon_bins * 0.75
        bin_height = chart_base_size / num_lat_bins * 0.95
