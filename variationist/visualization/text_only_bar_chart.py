...
class TextOnlyBarChart(AltairChart):
    """A class for building a BarChart object for text-only computations."""
    ...
    def __init__(
        ...
        """
        Initialization function for a building a BarChart object for text-only
        computations.
        ...
        # @TODO: Eventually merge with standard bar chart

        # Get relevant dimensions
        x_name, x_type = "value", "quantitative"
        y_name, y_type = "ngram", "nominal"
        column_name, column_type = "text_name", "nominal"
        color_name, color_type = "text_name", "nominal"
