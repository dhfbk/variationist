...
def number_of_sentences(label_values_dict, subsets_of_interest):  
    values_dict = dict()
...
def average_sentence_lengt(label_values_dict, subsets_of_interest):  
    values_dict = dict()
    for column in label_values_dict:
        for l in range(len(label_values_dict[column])):
            values_list = []
            ...
            for sentence in subsets_of_interest[column][l]:
                values_list.append(len(sentence))
...
def compute_basic_stats(label_values_dict, subsets_of_interest, args):  
    stats_dict = dict()
    stats_dict["number_of_sentences"] = number_of_sentences(label_values_dict, subsets_of_interest)
    stats_dict["average_sentence_length"] = average_sentence_lengt(label_values_dict, subsets_of_interest)
    print(stats_dict)
    return stats_dict